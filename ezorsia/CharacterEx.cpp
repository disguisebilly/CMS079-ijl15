...
LONGLONG get_next_level_exp()
{
	...
	short lvl = CharacterDataEx::GetInstance()->m_liLevel;

	int length = myArrayForCustomEXP.size();

	if (lvl >= length) return myArrayForCustomEXP[length - 1];
